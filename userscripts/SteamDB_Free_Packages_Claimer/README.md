...
description: "Automatically downloads podcast episodes from Podcast.de with customizable filename templates based on episode metadata, including a template tester."
